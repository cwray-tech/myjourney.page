            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden md:ml-6 md:flex">
                        @guest
                        <a href="/"
                           class="inline-flex items-center px-1 pt-1 border-b-2 @if(request()->routeIs('home')) border-yellow-500 text-gray-900 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-yellow-400 @endif text-sm font-medium leading-5  focus:outline-none focus:border-yellow-700 transition duration-150 ease-in-out">
                            Home
                        </a>
                        <a href="{{ route('journeys.index') }}"
                           class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 @if(request()->routeIs('journeys.index')) border-yellow-500 text-gray-900 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-yellow-400 @endif text-sm font-medium leading-5  focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            Public Journeys
                        </a>
                        <a href="{{ route('dashboard') }}"
                           class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 @if(request()->routeIs('dashboard')) border-yellow-500 text-gray-900 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-yellow-400 @endif text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-yellow-400 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            Dashboard
                        </a>
                        <a href="{{ route('user-journeys') }}"
                           class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 @if(request()->routeIs('user-journeys')) border-yellow-500 text-gray-900 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-yellow-400 @endif text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-yellow-400 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            Your Journeys
                        </a>
                            @else
                            <a href="{{ route('dashboard') }}"
