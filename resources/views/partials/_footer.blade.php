    ...
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="md:grid md:grid-cols-3 md:gap-8">
            <div class="md:col-span-1">
                ...
                <p class="mt-8 text-gray-500 text-base leading-9">
            ...
            <div class="mt-12 md:flex justify-end md:mt-0 md:col-span-2">
                <div class="grid grid-cols-2 md:grid-cols-3 md:gap-12 gap-6">
                    <div>
                        ...
                        <ul class="mt-4">
                            <li>
                                <a href="/" class="text-base leading-9 text-gray-500 hover:text-gray-900">
                                    Home
                                </a>
                            </li>
                            <li class="mt-4">
                                <a href="/journeys" class="text-base leading-9 text-gray-500 hover:text-gray-900">
                                    Public Journeys
                                </a>
                            </li>
                            <li class="mt-4">
                                <a href="/about" class="text-base leading-9 text-gray-500 hover:text-gray-900">
                                    About
                                </a>
                            </li>
                    ...
                    <div class="">
                        ...
                        <ul class="mt-4">
                            <li>
                                <a href="/dashboard" class="text-base leading-9 text-gray-500 hover:text-gray-900">
                                    Dashboard
                                </a>
                            </li>
                            <li class="mt-4">
                                <a href="/dashboard/journeys" class="text-base leading-9 text-gray-500 hover:text-gray-900">
                                    Your Journeys
                                </a>
                            </li>
                            <li class="mt-4">
                                <a href="{{ route('journeys.create') }}" class="text-base leading-9 text-gray-500 hover:text-gray-900">
                                    Write Journey
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul class="mt-4">
                            <li>
                                <a href="/privacy-policy" class="text-base leading-9 text-gray-500 hover:text-gray-900">
                                    Privacy Policy
                                </a>
                            </li>
                            <li class="mt-4">
                                <a href="/terms" class="text-base leading-9 text-gray-500 hover:text-gray-900">
                                    Terms & Conditions
                                </a>
                            </li>
        ...
        <div class="mt-12 border-t border-gray-200 pt-8">
            <p class="text-base leading-9 text-gray-400 xl:text-center">
