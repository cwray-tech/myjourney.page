<div id="{{ $step->id }}"
    ...
    @endif
    <div
        class="relative bg-white border-2 border-black border-r-none md:border-r-2 rounded-md journey-step-content px-6 py-10 rounded-r-none md:rounded-r prose prose-xl text-gray-500">
        @if($step->time)
