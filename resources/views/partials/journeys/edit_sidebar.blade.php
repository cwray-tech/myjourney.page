<div class="sticky top-10 lg:pr-6 md:w-1/3 pt-0 px-4 border rounded md:mt-0 mt-8 max-h-80 overflow-auto">
    <h2 class="text-3xl pb-2 pt-4 border-b border-black mb-4 sticky top-0 bg-white">Your Journey <a class="text-lg underline" target="_blank" href="{{ route('journeys.show', $journey->slug) }}">View</a> <a class="text-lg underline" href="{{ route('journeys.edit', $journey->slug) }}">Edit Intro</a></h2>
    <div class="px-1">
