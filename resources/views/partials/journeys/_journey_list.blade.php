@forelse($journeys as $journey)
    <a href="{{ route('journeys.show', $journey->slug) }}"  class="rounded-md bg-white md:flex items-stretch justify-start w-full overflow-hidden border hover:shadow hover:border-yellow-500 transition ease-in-out duration-150">
        @if($journey->picture)
